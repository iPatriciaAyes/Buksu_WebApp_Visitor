...
<body style='background:grey;'>
	...
	width: 20%;">
        ...
        <form action="insert.php" method="post">
            ...
            <h1 style="text-align: center;">Contact Tracing form</h1>
			<ul style="list-style: none">
            <div class="form-group">
                <li >1. Have you travel outside the country for the past few months?</li>
                <label class="radio-inline" style="align:center">
            ...
            <p><input type="checkbox">  I hereby certify that the information that I have given above are true, accurate and complete.</p>
